      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Have a project in mind or want to discuss how data analytics can help your business? Reach out through any of the links below.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-8 p-6 bg-gray-800 rounded-lg w-full max-w-lg text-center">
            <h4 className="font-bold mb-2">Email Me</h4>
            <p className="text-gray-300">
              Prefer to email? Reach me at <a href="mailto:contact@megansmith.com" className="text-accent hover:underline">contact@megansmith.com</a>
            </p>
          </div>
        </motion.div>
      </div>
